            ...
            >
                <div className="space-y-4">
                    <div className="relative flex items-center">
                        <At style={{color:"#f70b3e"}} className='w-6 h-6 absolute left-4 inset-y-0 my-auto'/>
                        <input
                            ref={email}
                            type="email"
                            name="email"
                ...
                <div className="space-y-4">
                    <div className="relative flex items-center">
                        <Password style={{color:"#f70b3e"}} className='w-6 h-6 absolute left-4 inset-y-0 my-auto'/>
                        <input
                            ref={password}
                            type="password"
                            name="password"
                ...
                <button type="submit"
                       style={{background:"#f70b3e"}}  className="bg-black rounded-xl relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
                                <span
